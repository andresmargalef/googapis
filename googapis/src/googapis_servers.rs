...
include_proto_server!("google.actions.sdk.v2.interactionmodel.prompt");
  }
...
include_proto_server!("google.actions.sdk.v2.interactionmodel.r#type");
  }
 }
 }
 }
...
include_proto_server!("google.ads.admanager.v1");
  }
 }
pub mod admob {  pub mod v1 { #[cfg(any(feature = "google-ads-admob-v1",))]
include_proto_server!("google.ads.admob.v1");
  }
 }
...
include_proto_server!("google.ads.googleads.v15.common");
  }
...
include_proto_server!("google.ads.googleads.v15.enums");
  }
...
include_proto_server!("google.ads.googleads.v16.common");
  }
...
include_proto_server!("google.ads.googleads.v16.enums");
  }
...
include_proto_server!("google.ads.googleads.v17.common");
  }
...
include_proto_server!("google.ads.googleads.v17.enums");
  }
...
include_proto_server!("google.ads.searchads360.v0.common");
  }
...
include_proto_server!("google.cloud.aiplatform.v1beta1.schema.predict.instance");
  }
pub mod params { #[cfg(any(feature = "google-cloud-aiplatform-v1beta1-schema-predict-params",))]
include_proto_server!("google.cloud.aiplatform.v1beta1.schema.predict.params");
  }
pub mod prediction { #[cfg(any(feature = "google-cloud-aiplatform-v1beta1-schema-predict-prediction",))]
include_proto_server!("google.cloud.aiplatform.v1beta1.schema.predict.prediction");
  }
 }
pub mod trainingjob {  pub mod definition { #[cfg(any(feature = "google-cloud-aiplatform-v1beta1-schema-trainingjob-definition",))]
include_proto_server!("google.cloud.aiplatform.v1beta1.schema.trainingjob.definition");
  }
 }
 }
 }
...
include_proto_server!("google.cloud.commerce.consumer.procurement.v1");
  }
pub mod v1alpha1 { #[cfg(any(feature = "google-cloud-commerce-consumer-procurement-v1alpha1",))]
include_proto_server!("google.cloud.commerce.consumer.procurement.v1alpha1");
  }
 }
 }
 }
...
include_proto_server!("google.cloud.gkehub.cloudauditlogging.v1alpha");
  }
 }
...
include_proto_server!("google.cloud.gkehub.metering.v1alpha");
  }
pub mod v1beta { #[cfg(any(feature = "google-cloud-gkehub-metering-v1beta",feature = "google-cloud-gkehub-v1beta",))]
include_proto_server!("google.cloud.gkehub.metering.v1beta");
  }
 }
...
include_proto_server!("google.cloud.orchestration.airflow.service.v1");
  }
pub mod v1beta1 { #[cfg(any(feature = "google-cloud-orchestration-airflow-service-v1beta1",))]
include_proto_server!("google.cloud.orchestration.airflow.service.v1beta1");
  }
 }
 }
 }
...
include_proto_server!("google.cloud.paymentgateway.issuerswitch.accountmanager.v1");
  }
 }
...
include_proto_server!("google.iam.v1");
 pub mod logging { #[cfg(any(feature = "google-iam-v1-logging",))]
include_proto_server!("google.iam.v1.logging");
  }
 }
pub mod v1beta { #[cfg(any(feature = "google-iam-v1beta",))]
include_proto_server!("google.iam.v1beta");
  }
...
include_proto_server!("google.iam.v2");
  }
pub mod v2beta { #[cfg(any(feature = "google-iam-v2beta",))]
include_proto_server!("google.iam.v2beta");
  }
 }
...
include_proto_server!("google.identity.accesscontextmanager.r#type");
  }
...
include_proto_server!("google.identity.accesscontextmanager.v1");
  }
 }
 }
...
include_proto_server!("google.logging.r#type");
  }
pub mod v2 { #[cfg(any(feature = "google-logging-v2",))]
include_proto_server!("google.logging.v2");
  }
 }
...
include_proto_server!("google.r#type");
  }
...
include_proto_server!("google.shopping.r#type");
  }
 }
...
include_proto_server!("grafeas.v1");
  }
